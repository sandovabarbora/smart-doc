    ...
    async def add_chunks(self, chunks: List[DocumentChunk]) -> List[str]:
        ...
        for chunk in chunks:
            ...
            metadata = {
                ...
                "chunk_id": chunk.id,
                "source": chunk.chunk_metadata.get("source", "unknown") if chunk.chunk_metadata else "unknown",
                "content_type": chunk.chunk_metadata.get("content_type", "paragraph") if chunk.chunk_metadata else "paragraph",
                "word_count": chunk.chunk_metadata.get("word_count", 0) if chunk.chunk_metadata else 0
            }
